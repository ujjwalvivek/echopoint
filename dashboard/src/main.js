...
function main() {
            ...
            <header class="topbar">
                ...
                <div class="topbarActions">
                    <a class="githubBadge" href="https://github.com/ujjwalvivek/echopoint" target="_blank" rel="noreferrer" title="Open Echopoint on GitHub">
                        <img src="${githubBadgeUrl}" alt="Echopoint GitHub stars" />
                    </a>
    ...
    Promise.all([
        ...
        .then(([icons, config]) => {
            ...
            ]).then(([{ initDocsData, renderDocs }, { setPlaygroundLogos, setPlaygroundConfig }]) => {
                setPlaygroundLogos(Object.keys(icons));
                if (config) setPlaygroundConfig(config);
